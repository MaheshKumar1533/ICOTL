...
export default function CallForPaper() {
  ...
  return (
    ...
    <p className='cfpNote1'>
      Individual submissions in the following area are invited.
Authors are invited to submit the full manuscript (maximum 6 pages including references) of their technical paper, for oral or poster presentation. Papers in pdf format may be uploaded via the web using the system at: https://easychair.com/ICOTL2023 
The authors need to open an account in EasyChair for paper submission.
Accepted papers will be published in the conference proceedings with an IEEE catalog number and ISBN number. The proceedings will be submitted for possible publication in IEEE Xplore and indexing by EI Compendex. </p> <br />


    <Typography variant='h5'>ICOTL 2023 topics include but not limited to the following:</Typography>
                <List>
                {
                  topics.map( topic => (
                    <ListItem className='submissionRuleListItem' >
                        <ListItemIcon className='rulesListItemIcon'>
                            <Brightness1Icon fontSize='xxs' className='brightnessIcon'/>
                        </ListItemIcon>
                        <ListItemText>
                            {topic}
                        </ListItemText>
