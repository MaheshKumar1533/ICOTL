    ...
    <div className="homeDiv">
      <div class="HomeBgImgDiv">
        ...
        <div class="text-block">
          <p className="line_1">The First</p>
          <p className="line_2"><span className='mainLetter'>I</span>nternational <span className='mainLetter'>C</span>onference</p>
          <p className="line_3"> on </p>
          <p className="line_4"><span className='mainLetter'>O</span>ptimization <span className='mainLetter'>T</span>echniques for <span className='mainLetter'>L</span>earning.</p>
